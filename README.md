...
Sudirman–Thamrin bukan sekadar jalan protokol — ini urat nadi lalu lintas Jakarta, tempat ribuan kendaraan bertemu setiap hari dari arah Blok M, Senayan, hingga Bundaran HI dan Kota. Koridor ini menjadi titik temu dari berbagai aliran kendaraan: pekerja kantoran yang menuju gedung-gedung perkantoran di sepanjang Sudirman, kendaraan umum (TransJakarta, angkutan online) yang mondar-mandir mengangkut penumpang, hingga kendaraan yang sekadar transit menuju kawasan lain di Jakarta. Dengan volume sebesar itu, kepadatan di sini bukan cuma soal "banyak kendaraan" — tapi soal bagaimana kendaraan-kendaraan itu berinteraksi di dalam satu jaringan jalan yang saling terhubung.

Setiap pagi dan sore, kemacetan di sini tidak muncul serentak di satu titik: ia merambat. Satu simpang macet karena antrean lampu merah, lalu kendaraan yang tertahan meluber ke ruas sebelumnya, memperlambat laju kendaraan di sana, yang kemudian memperlambat ruas sebelumnya lagi — begitu seterusnya, membentuk gelombang kemacetan yang bergerak sepanjang koridor seiring berjalannya waktu. Fenomena ini mirip dengan gelombang kejut (shockwave) dalam teori arus lalu lintas: satu gangguan kecil di satu titik bisa memicu efek berantai yang jauh lebih besar di ruas-ruas sekitarnya, bahkan lama setelah penyebab awalnya (misalnya kendaraan berhenti mendadak, atau penyempitan jalur) sudah tidak ada lagi.

Masalahnya, kebanyakan pendekatan prediksi lalu lintas konvensional — rata-rata historis, ARIMA per-ruas, bahkan model neural seperti LSTM — memperlakukan tiap ruas jalan secara terpisah, seolah-olah kondisi satu jalan tidak ada hubungannya dengan jalan di sebelahnya. Padahal kemacetan pada dasarnya adalah fenomena spasial: kondisi satu ruas jalan sangat dipengaruhi oleh ruas-ruas di sekitarnya, dan sebaliknya. Model yang hanya melihat pola waktu historis di satu titik — tanpa memahami struktur jaringan jalan secara keseluruhan — akan kesulitan menangkap bagaimana kemacetan menjalar dari satu titik ke titik lain, ke arah mana ia bergerak, dan seberapa cepat ia menyebar.

Di sinilah letak celah yang ingin dijawab proyek ini: dibutuhkan pendekatan yang tidak hanya "menghafal" pola waktu di tiap ruas, tapi benar-benar memodelkan jaringan jalan sebagai satu graf yang saling terhubung — di mana perubahan kondisi di satu node bisa merambat ke node-node tetangganya secara eksplisit, sekaligus dimodelkan sebagai proses yang berjalan kontinu terhadap waktu, bukan cuma pada kelipatan interval waktu tertentu.
